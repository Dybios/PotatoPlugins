...
3. Open `config.json` and update values in `cutoff_frequency` and `q_factor` fields as you desire.
4. If Capture endpoint was setup, restart the recording stream. If Render endpoint was setup, close and reopen the audio stream for audible effects.
